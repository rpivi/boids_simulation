...
TEST_CASE("testing the statistics functions") {
  ...
  SUBCASE("test 3") {
    ...
    CHECK(flock_statistic.std_dev_p(flock).x == doctest::Approx(0.57735));
    CHECK(flock_statistic.std_dev_p(flock).y == doctest::Approx(0.57735));
    CHECK(flock_statistic.mean_velocity(flock).x == 4.0);
    CHECK(flock_statistic.mean_velocity(flock).y == 5.0);
    CHECK(flock_statistic.std_dev_v(flock).x == doctest::Approx(0.57735));
    CHECK(flock_statistic.std_dev_v(flock).y == doctest::Approx(0.57735));
  }
}
